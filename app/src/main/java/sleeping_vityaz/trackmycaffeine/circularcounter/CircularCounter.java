package sleeping_vityaz.trackmycaffeine.circularcounter;
...
public class CircularCounter extends View {
	...
	/**
	 * View starts at 12 o'clock
	 */
	private final static float START_DEGREES = 270;
	...
	private void setupTextPosition() {
		...
		mTextPosY = mOneBounds.centerY() + (textBounds.height() / 2f) - 25;
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText(Integer.toString(mOneValue) + " mg today", mOneBounds.centerX(),
